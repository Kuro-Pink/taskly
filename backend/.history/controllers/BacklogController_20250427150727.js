    ...
    try {
       ...
       // 🎯 Gửi thông báo Notification
        const notification = {
            ...
            payload: {
                _id: newIssue._id,
                type: "assignment",     // Hoặc "progress", tùy bạn định nghĩa
                title: `New issue created: ${newIssue.title}`,
                message: `An issue has been created and assigned.`,
                isRead: false,
                createdAt: new Date().toISOString(),
                link: `/projects/${project}/issues/${newIssue._id}`
            }
        };
  
        sendWebSocketUpdate(SOCKET_EVENTS.CREATE_ISSUE, notification);
