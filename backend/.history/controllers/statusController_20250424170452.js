...
import { sendWebSocketUpdate } from '../utils/webSocket.js'; // Đảm bảo bạn có file này để xử lý WebSocket.
...
export const createStatus = async (req, res) => {
  try {
    ...
    sendWebSocketUpdate("CREATE_STATUS", {
      name, project
    });
...
export const updateStatus = async (req, res) => {
  try {
    ...
    // Gửi thông báo qua WebSocket
    sendWebSocketUpdate("UPDATE_STATUS", {
      id, name
    });
...
export const deleteStatus = async (req, res) => {
  try {
    ...
    // Gửi thông báo qua WebSocket
    sendWebSocketUpdate("DELETE_STATUS", {
      id
    });
