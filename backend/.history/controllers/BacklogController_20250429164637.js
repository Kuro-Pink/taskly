...
import { await sendNotificationToUser } from '../services/notificationService.js'; // Đảm bảo bạn có file này để xử lý WebSocket.
...
export const createIssue = async (req, res) => {
    try {
       ...
       // Gửi thông báo qua WebSocket (có thể sử dụng socket để phát sự kiện cho các thành viên dự án)
        await sendNotificationToUser(userId, SOCKET_EVENTS.RECEIVE_ACTIVITY, {
            _id: "",
