...
export const updateIssue = async (req, res) => {
    try {
        ...
        sendWebSocketUpdate("updateIssue", {
            issueId,
            ...req.body
          });
...
export const deleteIssue = async (req, res) => {
    try {
        ...
        sendWebSocketUpdate("deleteIsssue", { issueId });
...
export const createSprint = async (req, res) => {
    try {
        ...
        sendWebSocketUpdate("createSprint", { name, project });
...
export const updateSprint = async (req, res) => {
    try {
        ...
        sendWebSocketUpdate("updateSprint", { sprintId, ...req.body });
...
export const deleteSprint = async (req, res) => {
    try {
        ...
        sendWebSocketUpdate("deleteSprint", { sprintId });
...
export const startSprint = async (req, res) => {
    ...
    try {
        ...
        sendWebSocketUpdate("startSprint", { sprintId });
