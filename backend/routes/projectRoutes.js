...
import { sendInviteEmail, acceptInvite } from '../controllers/inviteController.js';
...
const router = express.Router();
  ...
  router.post("/join", protect, requestJoinProject); // Gửi yêu cầu tham gia
  ...
  router.post('/:projectId/invite', sendInviteEmail);
