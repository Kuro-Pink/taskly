...
const KanbanBoard = () => {
    ...
    const startedSprintIds = sprints?.filter(
        console.log('sprint started', sprint.started),
    ...
    const filteredIssues = issues?.filter((issue) => {
        ...
        const hasStatusInProject = statuses?.some((status) => {
            console.log(String(status.project) === String(currentProject?._id));
            console.log(String(status._id) === String(issue.status));
