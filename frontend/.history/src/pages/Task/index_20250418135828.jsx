...
const KanbanBoard = () => {
    ...
    const filteredIssues = issues?.filter((issue) => {
        ...
        console.log('issue.project', issue.project, 'currentProject._id', currentProject?._id);

        const isInStartedSprint = startedSprintIds.map((s) => String(s._id) === String(issue.sprint));
        const hasStatusOnly = !issue.sprint && issue.status;

        const hasStatusInProject = statuses?.map(
            (status) =>
