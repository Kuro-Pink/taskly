                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className="flex flex-col">
                                                            <span className={`font-bold ${getTypeColor(issue.type)}`}>
                                                                {issue.type}
                                                            </span>
                ...
                <div className="relative">
                    ...
                    <div className="relative bg-white" style={{ height: epics.length * 50 + 'px' }}>
                        {sprints
                            ...
                            .map((sprint) => {
                                // Lọc ra issue nào thuộc sprint này và có epic đang hiển thị
                                const matchingEpic = epics.find((epic) =>
                                    issues.some(
                                        (issue) =>
                                ...
                                if (!matchingEpic) return null;

                                const epicIndex = epics.findIndex((e) => e._id === matchingEpic._id);

                                return (
                                    <div
                                        key={sprint._id}
                                        className="absolute rounded bg-purple-500"
                                        style={{
