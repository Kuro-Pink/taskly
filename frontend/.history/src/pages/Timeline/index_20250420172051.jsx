                    ...
                    {epics
                        ...
                        .map((epic) => (
                            <div key={epic._id} className="border-b bg-white">
                                ...
                                {addingIssueEpicId === epic._id && (
                                    <div className="mt-2 mr-4 ml-6 rounded-md bg-white p-2 shadow">
                                        <input
                                            type="text"
                                        ...
                                        <div className="mt-2 flex gap-2">
                                            <button
                                                ...
                                                className="w-full rounded-md bg-blue-500 p-1 text-sm text-white hover:bg-blue-600"
                                            >
                                                Thêm Issue
                                            </button>
                                            <button
                                                ...
                                                className="w-full rounded-md bg-gray-300 p-1 text-sm hover:bg-gray-400"
                                            >
                                                Hủy
                                            </button>
                                        </div>
