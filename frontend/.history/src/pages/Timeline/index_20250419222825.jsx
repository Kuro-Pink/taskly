                        ...
                        <div key={epic._id} className="border-b bg-white">
                            ...
                            >
                                ...
                                <div className="flex gap-2">
                                    <button onClick={() => handleAddIssueToEpic(epic._id)} title="Thêm issue">
                                        ➕
                                    </button>
                                    <button
                                        onClick={() => {
                                    ...
                                    {confirmDeleteEpicId === epic._id ? (
                                        <>
                                            ...
                                            <button onClick={() => setConfirmDeleteEpicId(null)} title="Hủy">
                                                ❌
                                            </button>
                                        </>
                                    ) : (
                                        <button onClick={() => setConfirmDeleteEpicId(epic._id)} title="Xóa Epic">
                                            🗑️
                                        </button>
                                    )}
                                </div>
