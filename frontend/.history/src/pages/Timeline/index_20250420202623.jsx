...
const Timeline = () => {
    ...
    function getEpicBarStyle(sprint) {
        const start = moment(sprint.startDate);
        const end = moment(sprint.endDate);
        const firstDate = dateRange[0];

        const offsetDays = start.diff(firstDate, 'days');
                ...
                <div className="relative">
                    ...
                    <div className="relative">
                        ...
                        <div className="sticky top-0 z-10 bg-white">
                            ...
                            {/* 2. Sprint Inline Row */}
                            <div className="flex border-b px-2 py-1 text-xs whitespace-nowrap text-gray-700">
