...
const Timeline = () => {
    ...
    const handleAddIssueToEpic = async (epicId) => {
        ...
        const newIssue = {
            ...
            status: 'To Do',
            type: 'Task',
            // số thứ tự issue, key... có thể tự động sinh ở backend
        };
                    ...
                    {epics
                        ...
                        .map((epic) => (
                            <div key={epic._id} className="border-b bg-white">
                                ...
                                {addingIssueEpicId === epic._id && (
                                    <div className="flex items-center gap-2 pt-2 pr-2 pl-6">
                                        <input
