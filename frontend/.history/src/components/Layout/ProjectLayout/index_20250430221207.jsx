...
const ProjectLayout = ({ children }) => {
    ...
    useEffect(() => {
        ...
        socket.on('RECEIVE_ACTIVITY', (data) => {
            console.log('Received activity:', data); // Kiểm tra xem có nhận dữ liệu không
        });

        return () => {
            socket.off('RECEIVE_ACTIVITY'); // Hủy đăng ký sự kiện khi unmount
        };
    }, [id]);
