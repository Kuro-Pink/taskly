                    ...
                    <div className="flex w-[710px] items-center justify-between gap-4">
                        ...
                        {item.epic ? (
                            <button
                                ...
                                className="relative rounded border bg-gray-100 px-2 py-1 text-sm font-semibold text-gray-600 hover:bg-blue-500 hover:text-white"
                            >
                            ...
                            <button
                                ...
                                className="relative cursor-pointer rounded bg-gray-300 px-2 py-1 text-sm hover:bg-blue-500 hover:text-white"
                                title="Chọn Epic"
                            >
                                + Epic
                            </button>
                        ...
                        {showEpicMenuFor === item._id && (
                            <div
                                className="absolute z-10 mt-2 w-56 rounded-md border border-gray-300 bg-white shadow-xl"
                                tabIndex={0}
                            ...
                            >
                                ...
                                <ul className="divide-y divide-gray-100">
                                    ...
                                    {epics.filter((epic) => epic.projectId === currentProject._id).length === 0 && (
                                        <li className="px-4 py-2 text-sm text-gray-400 italic">Không có Epic nào</li>
                                    )}
                                </ul>
                            </div>
                        )}
