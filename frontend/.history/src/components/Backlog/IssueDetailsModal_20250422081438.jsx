                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-md border border-gray-300 bg-gray-300 px-3 py-2 text-sm text-blue-500 focus:ring-2 focus:ring-blue-400 focus:outline-none"
                                >
                                    {statuses
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        dispatch(
                                            updateIssue({
                                                issueId: issue._id,
                                                updates: { title: editedTitle, type: newType },
                                            }),
                                        )
                                            .unwrap()
                                            .then(() => {
