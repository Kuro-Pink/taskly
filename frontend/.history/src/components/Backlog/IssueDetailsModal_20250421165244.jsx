...
import { updateIssue, fetchIssueById, fetchAllIssue } from '../../redux/features/backlogSlice';
                    ...
                    <div className="mb-8 grid grid-cols-2 gap-6">
                        <select
                            ...
                            onChange={(e) => {
                                ...
                                setEditingIssueId(issue._id); // Kích hoạt edit
                                dispatch(
                                    updateIssue({ issueId: issue._id, updates: { title: editedTitle, type: newType } }),
                                )
                                    .unwrap()
                                    .then(() => {
                        ...
                        <div>
                            ...
                            {/* <input
                                ...
                                readOnly
                            /> */}
                            <h2>Header(Epic Name)</h2>
                        </div>

                        <div>
                            <label className="mb-1 block text-sm font-semibold text-gray-700">Sprint</label>
                            <input
                                className="text-yellow-5500 w-full rounded-md border border-gray-300 bg-gray-100 px-3 py-2 text-sm"
                                value={issue.sprint?.name || 'No Sprint'}
                                readOnly
                            />
                        </div>
                    </div>
