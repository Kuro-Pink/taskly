                ...
                <div className="flex w-full items-center justify-between gap-4">
                    ...
                    <div className="flex w-[710px] items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            className="cursor-pointer rounded bg-gray-300 p-2 px-2 py-1 hover:bg-blue-500 hover:text-white"
                            title="Chọn Epic"
                        >
                            + Epic
                        </button>
                        ...
                        {showEpicMenuFor === item._id && (
                            <div className="absolute z-10 mt-2 w-56 rounded-md border border-gray-300 bg-white shadow-xl">
