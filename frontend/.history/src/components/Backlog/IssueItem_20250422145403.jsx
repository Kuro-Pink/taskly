                ...
                <div className="flex w-full items-center justify-between gap-4">
                    ...
                    <div className="flex w-[710px] items-center justify-between gap-4">
                        ...
                        <button
                            onClick={(e) => {
                                e.stopPropagation();
                                setShowEpicMenuFor(item._id); // Mở dropdown của đúng item này
                            }}
                            className="relative cursor-pointer rounded bg-gray-300 p-2 px-2 py-1 hover:bg-blue-500 hover:text-white"
                            title="Chọn Epic"
                        >
                            + Epic
                        </button>
