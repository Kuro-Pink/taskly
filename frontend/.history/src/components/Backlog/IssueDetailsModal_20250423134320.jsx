                ...
                <div className="h-[612px] overflow-y-auto px-8 py-6">
                    ...
                    <div className="mb-8 grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                className="w-full rounded-md border border-gray-300 bg-gray-100 px-3 py-2 text-sm font-bold text-purple-500 focus:ring-2 focus:ring-blue-400 focus:outline-none"
